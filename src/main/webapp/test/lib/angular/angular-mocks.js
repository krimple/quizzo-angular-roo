 ...
 *
 * <pre>
 *   quizzoAppDev = angular.module('quizzoAppDev', ['quizzoApp', 'ngMockE2E']);
 *   quizzoAppDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('quizzoApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('quizzoApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('quizzoApplicationModule'));
   *
   *
